...
export class MathBN {
  static convert(num: BNInput): InstanceType<typeof BigNumberJS> {
    if (num == null) {
    ...
    return new BigNumberJS(num as InstanceType<typeof BigNumberJS> | number)
  }

  static add(...nums: BNInput[]): InstanceType<typeof BigNumberJS> {
  ...
  static sum(...nums: BNInput[]): InstanceType<typeof BigNumberJS> {
    return MathBN.add(0, ...(nums ?? [0]))
  }

  static sub(...nums: BNInput[]): InstanceType<typeof BigNumberJS> {
  ...
  static mult(n1: BNInput, n2: BNInput): InstanceType<typeof BigNumberJS> {
    const num1 = MathBN.convert(n1)
    const num2 = MathBN.convert(n2)
    return num1.times(num2)
  }

  static div(n1: BNInput, n2: BNInput): InstanceType<typeof BigNumberJS> {
    const num1 = MathBN.convert(n1)
    const num2 = MathBN.convert(n2)
    return num1.dividedBy(num2)
  }

  static abs(n: BNInput): InstanceType<typeof BigNumberJS> {
    const num = MathBN.convert(n)
    return num.absoluteValue()
  }

  static mod(n1: BNInput, n2: BNInput): InstanceType<typeof BigNumberJS> {
    const num1 = MathBN.convert(n1)
    const num2 = MathBN.convert(n2)
    return num1.modulo(num2)
  }

  static exp(n: BNInput, exp = 2): InstanceType<typeof BigNumberJS> {
    const num = MathBN.convert(n)
    const expBy = MathBN.convert(exp)
    return num.exponentiatedBy(expBy)
  }

  static min(...nums: BNInput[]): InstanceType<typeof BigNumberJS> {
    return BigNumberJS.minimum(...nums.map((num) => MathBN.convert(num)))
  }

  static max(...nums: BNInput[]): InstanceType<typeof BigNumberJS> {
